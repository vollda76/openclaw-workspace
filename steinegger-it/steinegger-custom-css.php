 ...
 * Description: Custom styles for Steinegger IT landing page
 * Version: 1.0
 * Author: VICA
 */
...
add_action('wp_head', 'steinegger_add_custom_css', 100);

function steinegger_add_custom_css() {
    ?>
    <style id="steinegger-it-styles">
    ...
    .is-layout-constrained{max-width:100%!important;padding-left:0!important;padding-right:0!important}
    .alignfull{margin-left:calc(50% - 50vw)!important;width:100vw!important;max-width:100vw!important}
    ...
    .steinegger-process-step{text-align:center}
